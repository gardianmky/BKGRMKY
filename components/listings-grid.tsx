...
interface ListingsGridProps {
  listings: Listing[];
  view?: 'compact' | 'detailed' | 'gallery';
  maxItems?: number;
  filterOptions?: FilterOptions;
  sortMethod?: 'price-asc' | 'price-desc' | 'newest' | 'relevance';
  onItemInteraction?: (listing: Listing) => void;
}

function useListingsProcessor(
  listings: Listing[],
  filterOptions?: FilterOptions,
  sortMethod?: string
) {
  ...
  }, [listings, filterOptions, sortMethod]);
}
...
function ListingCard({ listing }: ListingCardProps) {
  ...
  const isCommercial = type === "Commercial" || categories.includes("Commercial")
  ...
  return (
    ...
    >
      ...
      <div className="p-4 flex-grow flex flex-col">
        ...
        {/* Property Features - Only showing 2 features */}
...
export default function ListingsGrid({
  ...
  const processedListings = useListingsProcessor(listings, filterOptions, sortMethod);
