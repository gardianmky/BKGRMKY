...
import { Home, Bath, Car } from "lucide-react"
  ...
  useEffect(() => {
    async function fetchRentalListings() {
      try {
        ...
        const rentals = allListings.slice(0, 3)
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex justify-between text-sm text-gray-700 mb-5 border-t border-gray-100 pt-4">
                      <div className="flex items-center">
                        <Home className="h-5 w-5 text-teal-500 mr-1" />
                        <span>{beds} Beds</span>
                      </div>
                      <div className="flex items-center">
                        <Bath className="h-5 w-5 text-teal-500 mr-1" />
                        <span>{baths} Baths</span>
                      </div>
                      <div className="flex items-center">
                        <Car className="h-5 w-5 text-teal-500 mr-1" />
                        <span>{cars} Cars</span>
                      </div>
                    </div>
