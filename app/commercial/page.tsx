  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="bg-white p-8 rounded-xl shadow-md mb-10">
        <h1 className="text-3xl md:text-4xl font-bold mb-6">Commercial Properties</h1>
        <p className="text-gray-600 mb-6">
          Browse our selection of commercial properties in Mackay and surrounding areas. Find the perfect space for your
          business today!
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        <div className="lg:col-span-4">
          <SearchFilters category="commercial" className="mb-6" />
        </div>

        <div className="lg:col-span-4">
          <PropertyResults category="commercial" />
        </div>
      </div>
    </div>
  )
