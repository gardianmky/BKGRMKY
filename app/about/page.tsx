      ...
      <div className="bg-white p-8 rounded-xl shadow-md mb-10">
        ...
        <div className="prose max-w-none">
          ...
          <p>
            ...
            industry. We pride ourselves on our local knowledge, personalised service, and dedication to achieving the
          ...
          <ul className="list-disc pl-6 mb-6">
            <li>Delivering personalised service tailored to each client's unique needs</li>
